...
const navItems = [
  ...
  { id: 'arenden',          label: 'Felanmälningar', icon: AlertCircle },
  { id: 'serviceorder',    label: 'Serviceordrar',  icon: ClipboardList },
  { id: 'montageplanering', label: 'Montageordrar',  icon: Wrench     },
